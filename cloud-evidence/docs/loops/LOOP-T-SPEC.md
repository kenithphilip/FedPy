...
| T.T3 | CISA Common Form Generator (unsigned canonical PDF) | done | `PENDINGHASH` (2026-06-21) | T.T2, LOOP-A.A4 (bundler) | 5-6 working days |
...
| T.T3 | done | `PENDINGHASH` | 2026-06-21 | T.T2, LOOP-A.A4 | T.T4 | 5-6 working days |
