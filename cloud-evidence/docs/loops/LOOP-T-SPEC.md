...
|---|---|---|---|---|---|
| T.T1 | SSDF Practices Inventory (catalogue + extractor) | pending | — | LOOP-A.A1, LOOP-A.A4 | 4-5 working days |
...
| T.T2 | pending | — | — | T.T1, LOOP-B.B1, LOOP-J.J3, all KSI envelopes | T.T3, T.T4 | 5-6 working days |
